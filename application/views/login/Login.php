...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>UDBJOB</b>SV</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<?php echo base_url(); ?>registrar" class="text-center">Registrarte en UDBJOB</a><br>
    <a href="<?php echo base_url(); ?>regis rEmpresa" class="text-center">Registrarte como empresa.</a>

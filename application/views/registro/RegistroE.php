...
<div class="register-box" style="border: 3px solid #000000; width:60%">
  ...
  <div class="register-box-body">
    ...
    <p class="login-box-msg">Informacion Personal</p>
    <?php if ($error)
    {
    ...
    <?php echo form_open_multipart('CRegistroE/registrar'); ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <div class="form-group has-feedback">
            ...
            <p class="help-block">Extensión del archivo: jpg,png,jpeg.</p>
          </div>
        </div>
      </div>
      <br>
      <p class="login-box-msg">Informacion de la Empresa</p>

      <div class="row">
        <div class="col-xs-6">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Nombre de la Empresa" name="nombreEmp" required>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
        </div>
        <div class="col-xs-6">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Razon Social" name="razonSocial" required>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Numero de Trabajadores" name="numTrabajadores" required>
          </div>
        </div>
        <div class="col-xs-6">
          <div class="form-group has-feedback">
      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Sector" name="sector" required>
          </div>
        </div>
        <div class="col-xs-6">
          <div class="form-group has-feedback">

                                ...
                                <div class="box-body" id="caja-chat"  >
                                  ...
                                  <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                      <li>
                                        <a href="#">
                                          <img class="contacts-list-img" src="http://pngimage.net/wp-content/uploads/2018/06/usuario-icono-png.png" alt="User Image">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header " >
                        <h3 class="box-title">{Titulo de propuesta}</h3>
                    </div>
                    <div class="box-body ">
                            ...
                            <p>
                                  <button type="button" class="btn btn-primary btn-lg btn-block">Descargar Prueba</button>
                            </p>
                      </div>
                      <!-- /.box-body -->
                </div>     
